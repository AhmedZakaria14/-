...
const RiyadhContractingLogo = () => (
  <div className="h-28 w-full flex items-center justify-center">
    <img 
      src="/riyadh-contracting-logo.png" 
      alt="Riyadh Contracting" 
...
const DehanatMakaLogo = () => (
  <div className="h-28 w-full flex items-center justify-center">
    <img 
      src="/dehanat-maka-logo.png" 
      alt="معلم أبو كيان - دهانات مكة" 
      className="max-h-full max-w-full object-contain rounded-2xl shadow-md"
      referrerPolicy="no-referrer"
      loading="lazy"
      decoding="async"
...
const FurnitureFixImageLogo = () => (
  <div className="h-28 w-full flex items-center justify-center">
    <img 
      src="/furniture-fix-logo.png" 
      alt="Furniture Fix UAE" 
      className="max-h-full max-w-full object-contain rounded-2xl shadow-md"
      referrerPolicy="no-referrer"
      loading="lazy"
      decoding="async"
...
export const CLIENTS = [
  ...
  {
    id: 'furniture-fix',
    component: FurnitureFixImageLogo,
               ...
               if ('component' in client && client.component) {
                 ...
                 return (
                   <a 
                     ...
                     className="group relative h-28 w-auto min-w-[160px] px-4 flex items-center justify-center transition-all duration-300 hover:scale-110 filter grayscale hover:grayscale-0 opacity-70 hover:opacity-100"
                   >
                     <LogoComponent />
                   </a>
                 );
