...
export const SaudiLandingPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const title = "شركة تسويق رقمي في السعودية | نشار هب - إعلانات وسيو";
    const description = "نشار هب أفضل شركة تسويق رقمي في السعودية. خدمات إعلانات جوجل، سناب شات، سيو، وتصميم مواقع في الرياض وجدة والدمام.";
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed animate-fade-in-up opacity-0 delay-200">
              سواء كنت تبحث عن شركة برمجة مواقع، تصميم متاجر إلكترونية، أو إعلانات جوجل، نحن في نشار هب نقدم لك الحلول الرقمية المتكاملة لنجاحك في الرياض، جدة، الدمام، مكة، المدينة، وكافة أنحاء السعودية.
            </p>
