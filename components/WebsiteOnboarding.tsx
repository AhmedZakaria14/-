...
export const WebsiteOnboarding: React.FC<WebsiteOnboardingProps> = ({ lang, onBack }) => {
  useSEO({
    title: lang === 'en' ? 'Order Your Website | Web Development Agency | Nashar Hub' : 'اطلب تصميم موقعك أو متجرك الإلكتروني الاحترافي الآن | نشار هب',
    description: lang === 'en' ? 'Get a professional, high-converting website tailored to your business field. Start your digital transformation with Nashar Hub.' : 'ابدأ رحلة نجاحك الرقمي واطلب تصميم موقع تعريفي للشركات أو متجر إلكتروني احترافي. نقدم حلول ويب متكاملة، سريعة، ومتوافقة تماماً مع محركات البحث (SEO) لزيادة عملائك ومبيعاتك.',
    keywords: lang === 'en' ? 'Web Development, Order Website, Custom Website, E-commerce Development, Landing Page Design' : 'طلب تصميم موقع الكتروني, انشاء متجر الكتروني احترافي, تصميم موقع شركة, أفضل شركة برمجة مواقع, تصميم موقع تعريفي, تصميم صفحة هبوط احترافية, تطوير مواقع الويب, شركة تصميم مواقع',
  });
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-500">
                  {lang === 'en' 
                    ...
                    : 'هل تحتاج إلى إعلانات ممولة (جوجل، سناب شات، تيك توك) لمتجرك الجديد؟ عزز نتائجك بحملات إعلانية مصممة خصيصاً لك.'}
                </p>
              </div>
