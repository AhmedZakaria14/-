...
export const CustomCursor: React.FC = () => {
  ...
  return (
    <>
      ...
      <div 
        ref={cursorRef}
        className="fixed top-0 left-0 w-2.5 h-2.5 bg-secondary rounded-full pointer-events-none z-[9999] shadow-sm will-change-transform"
      ...
      <div 
        ref={followerRef}
        className={`fixed top-0 left-0 border rounded-full pointer-events-none z-[9998] flex items-center justify-center transition-[width,height,background-color,border-color] duration-200 ease-out will-change-transform ${
          isHovering 
