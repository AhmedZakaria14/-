...
export const SaudiLandingPage: React.FC = () => {
  ...
  useSEO({
    title: 'أفضل شركة تسويق إلكتروني وتصميم مواقع في السعودية | الرياض، جدة، الدمام وكافة المدن | نشار هب',
    description: 'نشار هب هي أفضل شركة تسويق إلكتروني وتصميم مواقع في السعودية. نقدم خدمات إعلانات جوجل، سيو، وبرمجة المتاجر في الرياض، جدة، مكة، المدينة، الدمام، وكافة أنحاء المملكة.',
    keywords: 'شركة تسويق الكتروني, شركة تسويق, شركة برمجة مواقع, تصميم مواقع, اعلانات جوجل, افضل شركة تسويق في السعودية, تصميم متاجر الكترونية, الرياض, جدة, الدمام, مكة, المدينة, الخبر, ابها, تبوك, الطائف, القصيم',
  });
    ...
    <div className="min-h-screen bg-slate-50 font-arabic text-slate-900 selection:bg-secondary/30" dir="rtl">
      ...
      <script 
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "أفضل شركة تسويق إلكتروني وتصميم مواقع في السعودية. نقدم خدمات إعلانات جوجل، سيو، وبرمجة المتاجر في الرياض، جدة، مكة، المدينة، الدمام، وكافة أنحاء المملكة.",
            "areaServed": [
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
          <a href="/" className="block transition-all duration-300 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-primary rounded-xl p-1 -m-1">
            <span className="font-extrabold text-slate-900 tracking-tighter text-2xl">
          ...
          <a 
            ...
            className="bg-[#25D366] hover:bg-[#20bd5a] text-white px-6 py-2.5 rounded-full font-bold transition-all shadow-lg shadow-green-500/20 flex items-center gap-2"
          >
            <MessageCircle size={20} />
            <span className="hidden sm:inline">اطلب موقعك الآن</span>
          </a>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-slate-600 mb-10 leading-relaxed animate-fade-in-up opacity-0 delay-200">
              سواء كنت تبحث عن شركة برمجة مواقع، تصميم متاجر إلكترونية، أو إعلانات جوجل وسناب شات، نحن في نشار هب نقدم لك الحلول الرقمية المتكاملة في الرياض، جدة، الدمام، مكة، المدينة، وكافة أنحاء السعودية.
            </p>
      ...
      <footer className="bg-slate-900 text-slate-400 py-8 text-center border-t border-slate-800">
        <p>© {new Date().getFullYear()} نشار هب. جميع الحقوق محفوظة.</p>
      </footer>
    </div>
  );
};
